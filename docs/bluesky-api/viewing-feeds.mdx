...
The client you created in the [Bluesky API](/docs/bluesky-api) section can fetch the authenticated user's timeline with `getTimeline`. It accepts two parameters: `cursor` and `limit`.
...
<Tabs groupId="sdk">
  <TabItem value="ts" label="TypeScript">
    ```typescript title="app.bsky.feed.getTimeline"
...
<Tabs groupId="sdk">
  <TabItem value="ts" label="TypeScript">
    ```typescript title="app.bsky.feed.getFeed"
    const { feed: postsArray, cursor: nextPage } = await client.call(
...
<Tabs groupId="sdk">
  <TabItem value="ts" label="TypeScript">
    ```typescript title="app.bsky.feed.getFeedGenerator"
...
<Tabs groupId="sdk">
  <TabItem value="ts" label="TypeScript">
    ```typescript title="app.bsky.feed.getAuthorFeed"
    const { feed: postsArray, cursor: nextPage } = await client.call(
