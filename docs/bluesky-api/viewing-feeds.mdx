...
The Bluesky agent you created in the [Bluesky API](/docs/bluesky-api) section has a dedicated `getTimeline` method that returns the authenticated user's timeline. It accepts two parameters: `cursor` and `limit`.
