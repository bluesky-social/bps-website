...
<Tabs groupId="sdk">
  <TabItem value="ts" label="TypeScript">
    ```typescript title="like"
      import { like } from '@bsky.app/sdk'
...
<Tabs groupId="sdk">
  <TabItem value="ts" label="TypeScript">
    ```typescript title="deleteLike"
      import { deleteLike } from '@bsky.app/sdk'
...
<Tabs groupId="sdk">
  <TabItem value="ts" label="TypeScript">
    ```typescript title="repost"
      import { repost } from '@bsky.app/sdk'
...
<Tabs groupId="sdk">
  <TabItem value="ts" label="TypeScript">
    ```typescript title="deleteRepost"
      import { deleteRepost } from '@bsky.app/sdk'
...
post](/docs/bluesky-api/creating-a-post#quote-posts) tutorial.
:::
