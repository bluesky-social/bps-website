...
Following, muting, and blocking are the basic social graph actions on Bluesky.
Following subscribes you to someone's posts, while muting and blocking both let
you limit your exposure to another user, in different ways: muting quietly
hides someone's posts from your feeds, while blocking prevents interaction in
both directions.
