...
description: TypeScript and Go clients for Jetstream — construct a client, pass a filter, and read decoded, typed events from one loop. No JSON parsing, no reconnect logic.
---
