...
<DocsHero eyebrow="Learn Bluesky" title="Build on Bluesky">
...
<DocsCardGrid
  items={[
    { title: 'Creating a post', body: 'Write your first record with rich text.', to: '/docs/get-started/creating-a-post' },
    { title: 'Viewing feeds', body: 'Fetch and render timelines and custom feeds.', to: '/docs/get-started/viewing-feeds' },
    { title: 'Likes & reposts', body: 'Create interactions between records.', to: '/docs/get-started/like-repost' },
    { title: 'Profiles', body: 'Resolve handles, DIDs, and profile data.', to: '/docs/get-started/profiles' },
  ]}
/>
...
- Keep going with the Learn Bluesky guides, like [creating a post with rich text](/docs/get-started/creating-a-post) or [viewing feeds](/docs/get-started/viewing-feeds).
