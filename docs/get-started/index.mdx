...
<DocsCardGrid
  items={[
    { tag: '01 · Post', title: 'Creating a post', body: 'Write your first record with rich text.', to: '/docs/get-started/creating-a-post' },
    { tag: '02 · Read', title: 'Viewing feeds', body: 'Fetch and render timelines and custom feeds.', to: '/docs/get-started/viewing-feeds' },
    { tag: '03 · Social', title: 'Likes & reposts', body: 'Create interactions between records.', to: '/docs/get-started/like-repost' },
    { tag: '04 · Identity', title: 'Profiles', body: 'Resolve handles, DIDs, and profile data.', to: '/docs/get-started/profiles' },
  ]}
/>
