...
The Bluesky agent you created in the [Learn Bluesky](/docs/get-started) section has a dedicated `getTimeline` method that returns the authenticated user's timeline. It accepts two parameters: `cursor` and `limit`.
