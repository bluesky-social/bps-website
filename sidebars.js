...
const sidebars = {
  ...
  // Learn Bluesky and Relay (an autogenerated sidebar can't place a link
  // mid-list). The Learn Bluesky children stay autogenerated from its folder.
  tutorialSidebar: [
    ...
    {type: 'category', label: 'Relay', link: {type: 'doc', id: 'relay'}, items: ['consuming-the-firehose']},
    {
      ...
      // new Learn Bluesky pages here.
      type: 'category',
      // "Learn Bluesky" — the novice-friendly intro route, deemphasized in
      // favor of Jetstream but kept approachable. Slug stays /get-started so
      // existing links don't break; only the label changed.
      label: 'Bluesky API',
      // bpsGsPath: marks the three-item onboarding path (Learn Bluesky, About
